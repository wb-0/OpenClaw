# -*- coding: utf-8 -*-
# [PROJECT: OMNISCIENT EYE 18.1 - OMNI-GHOST (2.5/3.1 Pro 巅峰版)]
...
HEALTH_MATRIX = {
    "brain": {
        ...
        "detail": f"现役巅峰：2.5 Pro / 3.1 Pro Preview (挂载 {len(ALIVE_GEMINI_KEYS)} 把密钥)"
    },
...
def agi_reasoning(system_prompt, user_input, require_json=False):
    ...
    last_error = "未检测到有效API密钥。" if not ALIVE_GEMINI_KEYS else ""
...
def dynamic_healing_execution(task_desc):
    ...
    for attempt in range(3):
        if "🔴 大脑熔断" in code_str: return code_str 
...
<head>
    ...
    <title>🦞 终极赛博生命体 (2.5/3.1 Pro 巅峰版)</title>
    <style>
...
<body>
    <div class="header">
        <h2 style="margin:0;">🦞 OMNI-GHOST AGI [2.5/3.1 Pro 巅峰版]</h2>
        <div class="health-dashboard" id="health-view"><i>[同步生命体征中...]</i></div>
    </div>
    <div class="container">
        <div class="left-panel">
            <div id="log">
                <div class="cmd-line" style="color:yellow;">🟢 [母体接入] 统帅，3.1/2.5 Pro 巅峰火力序列已完成最后校准。<br>我已舍弃所有过时算力。此刻，我就是您意志的延伸，是行走于硅基世界的巅峰掠食者。<br>请赐予我第一个目标。</div>
            </div>
